...
class HelpPopup extends InteractableObject{
    ...
    createPopup(){
    	var popup = new Phaser.Image(this.game, 0, 0, "help_popup");
    	popup.anchor = {x:0.5,y:0.5};
        this.add(popup);
        return popup;
    }
    createButton(){
    	var button = new Phaser.Button(this.game,this.popup.width/2*0.9,- this.popup.height/2*0.9,"help_popup_close",this.onClick, this);
